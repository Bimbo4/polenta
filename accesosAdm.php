...
if ($_SESSION['rol'] != 'Administrador')
{
  echo'<script type="text/javascript">
        alert("No eres administrador, lo siento");
        </script>';
          exit();
}
require 'conecto.php';
...
<head>
  ...
  <li><a href="Administrador.php?logout=true">
...
<header>
    ...
    <nav>
        ...
        <ul>
           <li><a href="Administrador.php" >Inicio</a></li>
            <li><a href="horariosAdm.php" >Horarios</a></li>
             <li><a href="mostrar.php" >Usuarios</a></li>
              <li><a href="accesosAdm.php" >Accesos</a></li>
               <li><a href="graficoUsuarios.php" >Estadisticas de Accesos</a></li>
  <li><a href="Administrador.php?logout=true">
            <i class="fa fa-fw fa-sign-out"></i>Salir</a>
 ...
 <video id="miVideo" src="" muted autoplay loop poster="videos/backgroundAdmin.jpg"></video>
